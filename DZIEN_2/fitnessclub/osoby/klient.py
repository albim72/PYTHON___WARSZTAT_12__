...
class Klient(Trener,Sport):
    def __init__(self,nr_klienta,imie,wiek,waga,wzrost,nr_kb,nazwa,miasto,dyscyplina,lata_upr,zyciowka,nr_licencji=""):
        Trener.__init__(self,imie,wiek,waga,wzrost,
                 nr_kb,nazwa,miasto,nr_licencji,lata_dosw="",expert="")
